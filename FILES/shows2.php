  ...
  <div class="tail-bottom">
    <div id="main">
     ...
     <?php
        ...
        $sql = "select * from showtime where sid=2";
                        ...
                        ?>   
                                <form action="updateshow.php" method="POST">
                                    <input type="hidden" name="sid" value="2">
                                        <?php
                                        if ($row['time'] == "9AM")
                                            echo '<input type="hidden" name="showid" value="5">';
                                        else if ($row['time'] == "1PM")
                                            echo '<input type="hidden" name="showid" value="6">';
                                        else if ($row['time'] == "5PM")
                                            echo '<input type="hidden" name="showid" value="7">';
                                        else if ($row['time'] == "9PM")
                                            echo '<input type="hidden" name="showid" value="8">';
                                    ?>
                                <table border="0">
                                <tr style="height: 30px;">
                                    ...
                                    <?php       $sql5 = "select * from showtime natural join movies where sid=2 and time='".$row['time']."'";
