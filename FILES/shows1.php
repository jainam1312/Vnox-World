  ...
  <div class="tail-bottom">
    <div id="main">
     ...
     <?php
        ...
        $sql = "select * from showtime where sid=1";
                        ...
                        ?>   
                                <form action="updateshow.php" method="POST">
                                    <input type="hidden" name="sid" value="1">
                                        <?php
                                        if ($row['time'] == "9AM")
                                            echo '<input type="hidden" name="showid" value="1">';
                                        else if ($row['time'] == "1PM")
                                            echo '<input type="hidden" name="showid" value="2">';
                                        else if ($row['time'] == "5PM")
                                            echo '<input type="hidden" name="showid" value="3">';
                                        else if ($row['time'] == "9PM")
                                            echo '<input type="hidden" name="showid" value="4">';
                                    ?>
                                <table border="0">
                                <tr style="height: 30px;">
                                    ...
                                    <?php       $sql5 = "select * from showtime natural join movies where sid=1 and time='".$row['time']."'";
