      ...
      <div id="content">
          ...
          <table border="0">
                                ...
                                <tr style="height: 30px;">
                                    ...
                                    <td><div class="wrapper"><input type="submit" name="submit" value="Search"></div></td>   
                                </tr>
          </table></form>
        ...
        <div class="content" style="padding: 0 !important">
            ...
            <h3>You searched for <span><?php echo $_GET['query']; ?></span></h3><br><br>
          
          <ul class="movies"> 

            <?php while($row = mysqli_fetch_array($res)) { if(!strcasecmp($row['movietitle'],$_GET['query'])) {  if( ($counter+1)%3 != 0)	{?>
            	
            		<li>
              	 		<?php echo "<h4>".strtoupper($row['movietitle'])."[".$row['language']."]</h4>";?>
               			<img src="<?php echo $row['poster']; ?>" height="300px" width="200px" style="margin: 0;" />
                                <?php echo "<h3>";if($row['status']==0) echo "Ongoing"; else echo "Upcoming"; echo "</h3>"?>
               			<?php echo "<h3>Rating $row[rating]"."/10</h3>";?>
               			<?php echo "<p>$row[storyline]</p>";?>

               			<div class="wrapper"><a href="book.php?mid=<?php echo $row['mid'];?>" class="link2"><span><span><?php if($row['status']==0) echo "Book Now"; else echo "Book Advance";?></span></span></a> &nbsp; &nbsp; <a href="<?php echo $row['trailer_link']?>" class="link2" target="_blank"><span> <span> See Trailer</span> </span></a> </div>
            		</li>
            		&nbsp;
        		<?php } else {?>
            ...
            <?php $counter++; }}if(!$counter) echo "No Searches Found"; ?>
        <?php }?>
