        ...
        <div class="row-1">
          ...
          <ul>
            ...
            <?php
                ...
                {
                    echo '<li><a href="users.php" title="account"><img src="images/icon2.png" alt="" /></a></li>';
                }
                else
                {
...
if(!isset($_SESSION['log']))
    ...
    else
    {
                ...
                $con= mysqli_connect("localhost", "root", "", "movieproject");
                $sql1 = "select * from showtime where mid= '".$_GET['movieid']."'";
                $res = mysqli_query($con,$sql1);
                $row = mysqli_fetch_array($res);
                if(empty($row)){
                    $sql = "delete from movies where mid= '".$_GET['movieid']."'";
               ...
               echo mysqli_error($con);
                ...
                {
                    echo '<h3>Something Went <span>Wrong:</span></h3><br><br>';
                    echo 'This movie has shows in screens ... First remove Shows then try to delete movie ...';
                }
