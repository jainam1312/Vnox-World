...
<?php 
	if(isset($_POST['mid']) && isset($_POST['date']) && isset($_POST['name']) && isset($_POST['time']) && isset($_POST['lan']) ){
...
<div class="content">
	<h1>Vnox World</h1>
	<div class="main">
		<?php echo'<h2>'.$mtitle.' Showing Screen '.($_POST['sid']).'</h2>'; ?>
		<div class="demo">
			<div id="seat-map">
